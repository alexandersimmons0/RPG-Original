...
public class Enemy : MonoBehaviourPun{
    ...
    void Die(){
        int obToSpawn = Random.Range(0,objectToSpawnOnDeath.Length);
        if(objectToSpawnOnDeath[obToSpawn] != null){
            PhotonNetwork.Instantiate(objectToSpawnOnDeath[obToSpawn], transform.position, Quaternion.identity);
